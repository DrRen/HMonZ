namespace HMonZ.GUI {
  partial class PortForm {
    ...
    private void InitializeComponent() {
            ...
            this.portCancelButton.Text = "Отмена";
            ...
            this.label1.Text = "Вам нужно будет настроить порт в файрволл Windows";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Номер порта к удалённому Web-серверу:";
            // 
            // label4
            // 
            ...
            this.label4.Text = "Сервер будет доступен по адресу:";
            // 
            // webServerLinkLabel
            // 
            this.webServerLinkLabel.AutoSize = true;
            this.webServerLinkLabel.Location = new System.Drawing.Point(199, 62);
            ...
            // portNumericUpDn
            // 
            this.portNumericUpDn.Location = new System.Drawing.Point(237, 7);
            ...
            this.label5.Text = "Чтобы запустить Web-сервер нажмите на кнопку \"Запустить\" в меню.";
            // 
            // PortForm
            // 
