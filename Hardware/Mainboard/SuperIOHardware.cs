  ...
  internal sealed class SuperIOHardware : Hardware {
      ...
      switch (superIO.Chip) {
        ...
        case Chip.F71858:
          ...
          for (int i = 0; i < superIO.Temperatures.Length; i++)
            t.Add(new Temperature("Температура #" + (i + 1), i));
          for (int i = 0; i < superIO.Fans.Length; i++)
            f.Add(new Fan("Вентелятор #" + (i + 1), i));
          break;
        case Chip.F71862:
        case Chip.F71869:
        case Chip.F71869A:
        ...
        case Chip.W83627THF:
        case Chip.W83687THF:
          v.Add(new Voltage("Напряжения процессора", 0));
          v.Add(new Voltage("Напряжение #2", 1, true));
          v.Add(new Voltage("Напряжение #3", 2, true));
          v.Add(new Voltage("AVCC", 3, 34, 51));
          v.Add(new Voltage("Напряжение #5", 4, true));
        ...
        case Chip.NCT610X:
          v.Add(new Voltage("Напряжения процессора", 0));
          v.Add(new Voltage("Напряжение #0", 1, true));
          v.Add(new Voltage("AVCC", 2, 34, 34));
          v.Add(new Voltage("3VCC", 3, 34, 34));
          v.Add(new Voltage("Напряжение #1", 4, true));
          v.Add(new Voltage("Напряжение #2", 5, true));
          v.Add(new Voltage("Reserved", 6, true));
          v.Add(new Voltage("3VSB", 7, 34, 34));
          v.Add(new Voltage("VBAT", 8, 34, 34));
          v.Add(new Voltage("Напряжение #10", 9, true));
          t.Add(new Temperature("SYS", 1));
          t.Add(new Temperature("CPU Ядро", 2));
          t.Add(new Temperature("AUX", 3));
          for (int i = 0; i < superIO.Fans.Length; i++)
            f.Add(new Fan("Вентелятор #" + (i + 1), i));
          for (int i = 0; i < superIO.Controls.Length; i++)
            c.Add(new Ctrl("Контроль вент. #" + (i + 1), i));
          break;
        case Chip.NCT6779D:
        case Chip.NCT6791D:
      ...
      IList<Voltage> v, IList<Temperature> t, IList<Fan> f, IList<Ctrl> c) 
    {
      for (int i = 0; i < superIO.Voltages.Length; i++)
        v.Add(new Voltage("Напряжение #" + (i + 1), i, true));
      for (int i = 0; i < superIO.Temperatures.Length; i++)
        t.Add(new Temperature("Температура #" + (i + 1), i));
      for (int i = 0; i < superIO.Fans.Length; i++)
        f.Add(new Fan("Вентелятор #" + (i + 1), i));
        ...
        case Manufacturer.ASUS:
          switch (model) {
            ...
            case Model.M2N_SLI_DELUXE:
              ...
              v.Add(new Voltage("VBat", 8));
              t.Add(new Temperature("CPU", 0));
              t.Add(new Temperature("Мат. плата", 1));
              f.Add(new Fan("CPU Fan", 0));
              f.Add(new Fan("Chassis Вентелятор #1", 1));
            ...
            case Model.M4A79XTD_EVO: // IT8720F           
              ...
              f.Add(new Fan("CPU Fan", 0));
              f.Add(new Fan("Chassis Вентелятор #1", 1));
              f.Add(new Fan("Chassis Вентелятор #2", 2));
              break;
            default:
              v.Add(new Voltage("Напряжение CPU", 0));
              v.Add(new Voltage("Напряжение #2", 1, true));
              v.Add(new Voltage("Напряжение #3", 2, true));
              v.Add(new Voltage("Напряжение #4", 3, true));
              v.Add(new Voltage("Напряжение #5", 4, true));
              v.Add(new Voltage("Напряжение #6", 5, true));
              v.Add(new Voltage("Напряжение #7", 6, true));
              v.Add(new Voltage("Напряжение #8", 7, true));
              v.Add(new Voltage("VBat", 8));
              for (int i = 0; i < superIO.Temperatures.Length; i++)
                t.Add(new Temperature("Температура #" + (i + 1), i));
              for (int i = 0; i < superIO.Fans.Length; i++)
        ...
        case Manufacturer.DFI:
          switch (model) {
            case Model.LP_BI_P45_T2RS_Elite: // IT8718F
              ...
              f.Add(new Fan("Вентелятор #1", 0));
              f.Add(new Fan("Вентелятор #2", 1));
              f.Add(new Fan("Вентелятор #3", 2));
              break;
        ...
        case Manufacturer.Gigabyte:
          switch (model) {
            ...
            case Model.X38_DS5:
              ...
              t.Add(new Temperature("CPU", 1));
              f.Add(new Fan("CPU Fan", 0));
              f.Add(new Fan("System Вентелятор #2", 1));
              f.Add(new Fan("Power Fan", 2));
              f.Add(new Fan("System Вентелятор #1", 3));
              break;
            ...
            case Model.P35_DS3L: // IT8718F
              ...
              t.Add(new Temperature("CPU", 1));
              f.Add(new Fan("CPU Fan", 0));
              f.Add(new Fan("System Вентелятор #1", 1));
              f.Add(new Fan("System Вентелятор #2", 2));
      ...
      ref Mutex mutex) 
    {
      ...
      if (exclusiveAccess) {
        ...
        f.Add(new Fan("Chassis Вентелятор #2", 2));
        f.Add(new Fan("Chassis Вентелятор #3", 3));
        f.Add(new Fan("Power Fan", 4));
        ...
        case Manufacturer.ECS:
          switch (model) {
            case Model.A890GXM_A: // IT8721F
              ...
              break;
            default:
              v.Add(new Voltage("Напряжение #1", 0, true));
              v.Add(new Voltage("Напряжение #2", 1, true));
              v.Add(new Voltage("Напряжение #3", 2, true));
        ...
        case Manufacturer.Gigabyte:
          switch (model) {
            ...
            case Model.H61M_USB3_B3_REV_2_0: // IT8728F
              ...
              v.Add(new Voltage("Напряжения процессора", 5));
              v.Add(new Voltage("DRAM", 6));
              v.Add(new Voltage("Standby +3.3V", 7, 10, 10));
              v.Add(new Voltage("VBat", 8, 10, 10));
              t.Add(new Temperature("System", 0));
            ...
            case Model.H67A_USB3_B3: // IT8728F                
              ...
              f.Add(new Fan("System Вентелятор #1", 1));
              f.Add(new Fan("Power Fan", 2));
              f.Add(new Fan("System Вентелятор #2", 3));
              break;
            ...
            case Model.Z68X_UD7_B3: // IT8728F
              ...
              f.Add(new Fan("System Вентелятор #1", 2));
              f.Add(new Fan("System Вентелятор #2", 3));
              f.Add(new Fan("System Вентелятор #3", 4));
              break;
            default:
              v.Add(new Voltage("Напряжение #1", 0, true));
              v.Add(new Voltage("Напряжение #2", 1, true));
        ...
        case Manufacturer.EVGA:
          switch (model) {
            case Model.X58_SLI_Classified: // F71882 
              v.Add(new Voltage("VCC3V", 0, 150, 150));
              v.Add(new Voltage("Напряжения процессора", 1, 47, 100));
            ...
            default:
              v.Add(new Voltage("VCC3V", 0, 150, 150));
              v.Add(new Voltage("Напряжения процессора", 1));
              v.Add(new Voltage("Напряжение #3", 2, true));
              v.Add(new Voltage("Напряжение #4", 3, true));
              v.Add(new Voltage("Напряжение #5", 4, true));
              v.Add(new Voltage("Напряжение #6", 5, true));
        ...
        case Manufacturer.ASUS:
          switch (model) {
            ...
            case Model.P8P67_PRO: // NCT6776F
              ...
              t.Add(new Temperature("Мат. плата", 3));
              f.Add(new Fan("Chassis Вентелятор #1", 0));
              f.Add(new Fan("CPU Fan", 1));
              f.Add(new Fan("Power Fan", 2));
              f.Add(new Fan("Chassis Вентелятор #2", 3));
              c.Add(new Ctrl("Chassis Вентелятор #2", 0));
              c.Add(new Ctrl("CPU Fan", 1));
              c.Add(new Ctrl("Chassis Вентелятор #1", 2));
              break;
            ...
            case Model.P8Z68_V_PRO: // NCT6776F
              ...
              for (int i = 0; i < superIO.Fans.Length; i++)
                f.Add(new Fan("Вентелятор #" + (i + 1), i));
              for (int i = 0; i < superIO.Controls.Length; i++)
                c.Add(new Ctrl("Вентелятор #" + (i + 1), i));
              break;
            ...
            default:
              ...
              v.Add(new Voltage("3VSB", 7, 34, 34));
              v.Add(new Voltage("VBAT", 8, 34, 34));
              t.Add(new Temperature("CPU Ядро", 0));
              t.Add(new Temperature("Температура #1", 1));
              t.Add(new Temperature("Температура #2", 2));
              t.Add(new Temperature("Температура #3", 3));
              for (int i = 0; i < superIO.Fans.Length; i++)
                f.Add(new Fan("Вентелятор #" + (i + 1), i));
              for (int i = 0; i < superIO.Controls.Length; i++)
                c.Add(new Ctrl("Контроль вент. #" + (i + 1), i));
        ...
        case Manufacturer.ASUS:
          switch (model) {
            case Model.P8Z77_V: // NCT6779D
              ...
              v.Add(new Voltage("Напряжение #11", 10, true));
              v.Add(new Voltage("Напряжение #12", 11, true));
              v.Add(new Voltage("Напряжение #13", 12, true));
              v.Add(new Voltage("Напряжение #14", 13, true));
              v.Add(new Voltage("Напряжение #15", 14, true));
              t.Add(new Temperature("CPU Ядро", 0));
              t.Add(new Temperature("Auxiliary", 1));
              t.Add(new Temperature("Мат. плата", 2));
              f.Add(new Fan("Chassis Вентелятор #1", 0));
              f.Add(new Fan("CPU Fan", 1));
              f.Add(new Fan("Chassis Вентелятор #2", 2));
              f.Add(new Fan("Chassis Вентелятор #3", 3));
              c.Add(new Ctrl("Chassis Вентелятор #1", 0));
              c.Add(new Ctrl("CPU  Fan", 1));
              c.Add(new Ctrl("Chassis Вентелятор #2", 2));
              c.Add(new Ctrl("Chassis Вентелятор #3", 3));
              break;
            default:
              v.Add(new Voltage("Напряжения процессора", 0));
              v.Add(new Voltage("Напряжение #2", 1, true));
              ...
              t.Add(new Temperature("Температура #2", 2));
              t.Add(new Temperature("Температура #3", 3));
              t.Add(new Temperature("Температура #4", 4));
              t.Add(new Temperature("Температура #5", 5));
              t.Add(new Temperature("Температура #6", 6));
              for (int i = 0; i < superIO.Fans.Length; i++)
                f.Add(new Fan("Вентелятор #" + (i + 1), i));
              for (int i = 0; i < superIO.Controls.Length; i++)
                c.Add(new Ctrl("Контроль вент. #" + (i + 1), i));
        ...
        case Manufacturer.ASRock:
          switch (model) {
            ...
            default:
              ...
              f.Add(new Fan("CPU Fan", 1));
              f.Add(new Fan("Auxiliary Fan", 2));
              f.Add(new Fan("CPU Вентелятор #2", 3));
              f.Add(new Fan("Auxiliary Вентелятор #2", 4));
              break;
          } break;
        default:
          v.Add(new Voltage("Напряжения процессора", 0));
        ...
        case Manufacturer.ASUS:
          switch (model) {
            ...
            case Model.Rampage_II_GENE: // W83667HG 
              ...
              f.Add(new Fan("Power Fan", 2));
              f.Add(new Fan("Chassis Вентелятор #2", 3));
              f.Add(new Fan("Chassis Вентелятор #3", 4));
              break;
